...
console.log("Async - страница и скрипты будут выполнятся по мере загрускию.");
console.log("Defer - сначало загружается страница потом скрипты в порядке их подключения в коде страницы.");